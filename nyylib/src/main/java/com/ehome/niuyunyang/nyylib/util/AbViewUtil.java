...
import com.ehome.niuyunyang.nyylib.global.AbAppConfig;
import com.ehome.niuyunyang.nyylib.widget.pullrefreshview.AbListViewFooter;
import com.ehome.niuyunyang.nyylib.widget.pullrefreshview.AbListViewHeader;
...
public class AbViewUtil {
    ...
    */
    public static void setViewSize(View view,int widthPixels, int heightPixels){
        ...
        if(params == null){
			Log.e("AbViewUtil"+":"+"setViewSize","setViewSize出错,如果是代码new出来的View，需要设置一个适合的LayoutParams");
