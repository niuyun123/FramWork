...
package com.ehome.niuyunyang.nyylib.util.netstatus;
...
public class NetStateReceiver extends BroadcastReceiver {
    ...
    public final static String CUSTOM_ANDROID_NET_CHANGE_ACTION = "com.ehome.niuyunyang.nyylib.net.conn.CONNECTIVITY_CHANGE";
