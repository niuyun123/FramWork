...
import com.ehome.niuyunyang.nyylib.model.AbAppProcessInfo;
import com.ehome.niuyunyang.nyylib.model.AbCPUInfo;
import com.ehome.niuyunyang.nyylib.model.AbProcessInfo;
import com.ehome.niuyunyang.nyylib.model.AbPsRow;
...
public class AbAppUtil {
    ...
    public static AbProcessInfo getMemInfo(String processName) {
        ...
        if(process.memory == 0){
        	Log.e("AbAppUtil"+":"+"getMemInfo","##"+processName+",top -n 1未找到");
	...
	public static String runCommand(String[] command, String workdirectory){
		String result = "";
		Log.e("AbAppUtil"+":"+"runCommand","#"+command);
	...
	public static long getTotalMemory(Context context){
        ...
        try{
            ...
            for(String str:strs){
				Log.e("AbAppUtil"+":"+"getTotalMemory",str+"\t");
