package com.ehome.niuyunyang.nyylib.widget;
...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        setTitleColor(Color.parseColor("#4D4D4D"));
        setSubTitleColor(Color.GRAY);
        setDividerColor(Color.GRAY);
        setActionTextColor(Color.parseColor("#4D4D4D"));
        addAction(new ImageAction(R.drawable.ic_more) {
            @Override
            public void performAction(View view) {
                Toast.makeText(finalContext, "更多", Toast.LENGTH_SHORT).show();
            }
        });
       /* addAction(new TitleBar.TextAction("发布") {
            @Override
            public void performAction(View view) {
