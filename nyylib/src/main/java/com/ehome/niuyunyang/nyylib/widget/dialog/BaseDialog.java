package com.ehome.niuyunyang.nyylib.widget.dialog;
...
/**
 * Created by niuyunyang on 17/4/15.
 */
...
//        });
    ...
    /**
     *
     * @param layoutId   需要加载的布局
     * @param width    布局的高度
     * @param heighth   布局的宽度
     */
    public void setContentViewWithSize(int layoutId,int width,int heighth) {
        setContentView(LayoutInflater.from(context).inflate(layoutId,null), new ViewGroup.LayoutParams(width, heighth));
    }
