package com.ehome.niuyunyang.nyylib.util.log;


import android.util.Pair;

import com.ehome.niuyunyang.nyylib.util.log.logger.Logger;
import com.ehome.niuyunyang.nyylib.util.log.logger.Printer;
import com.ehome.niuyunyang.nyylib.util.log.logger.Settings;
...
/**
 * Created by niuyunyang on 15/12/18.
 */
public class LogUtil {
    ...
    public static void json(Object json) {
        Logger.t(getClassName()).json(new Gson().toJson(json));
    }
