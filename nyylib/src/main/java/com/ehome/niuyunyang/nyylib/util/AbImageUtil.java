...
import com.ehome.niuyunyang.nyylib.util.dct.FDCT;
...
public class AbImageUtil {
	...
	public static Bitmap getBitmap(String url) {
		...
		try {
			...
			Log.e("AbImageUtil"+":"+"getBitmap","" + e.getMessage());
	...
	public static Bitmap getBitmap1(String filePath) {
		Bitmap resizeBmp = null;
		try {
	...
	public static Bitmap getCompressBitmapByStandardSize(String filePath, int standardSize) {
...
//	}
	...
	private static boolean checkBitmap(Bitmap bitmap) {
		if (bitmap == null) {
			Log.e("AbImageUtil"+":"+"checkBitmap", "原图Bitmap为空了");
			return false;
		}

		if (bitmap.getWidth() <= 0 || bitmap.getHeight() <= 0) {
			Log.e("AbImageUtil"+":"+"checkBitmap", "原图Bitmap大小为0");
			return false;
		}
		return true;
	}
	...
	private static boolean checkSize(int desiredWidth, int desiredHeight) {
		if (desiredWidth <= 0 || desiredHeight <= 0) {
			Log.e("AbImageUtil"+":"+"checkBitmap", "请求Bitmap的宽高参数必须大于0");
			return false;
		}
		return true;
	}
		...
		if (bitmap != null) {
			try {
				if (!bitmap.isRecycled()) {
					Log.e("AbImageUtil"+":"+"releaseBitmap","Bitmap释放" + bitmap.toString());
			...
			try {
				for (Bitmap bitmap : bitmaps) {
					if (bitmap != null && !bitmap.isRecycled()) {
						Log.e("AbImageUtil"+":"+"releaseBitmapArray","Bitmap释放" + bitmap.toString());
